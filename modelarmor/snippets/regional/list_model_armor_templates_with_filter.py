...
def list_model_armor_templates_with_filter(project_id: str, location_id: str, template_id: str) -> List[str]:
    """
    ...
    templates = client.list_templates(
        request=modelarmor_v1.types.ListTemplatesRequest(
            parent=parent,
            filter=f'name="{parent}/templates/{template_id}"'
        )
    )
...
if __name__ == "__main__":
    ...
    list_model_armor_templates_with_filter("ma-crest-data-test", "us-central1", "test-harsh")
