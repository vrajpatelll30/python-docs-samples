...
def update_model_armor_template_with_metadata(project_id: str, location_id: str, template_id: str, updated_filter_config_data: Dict, metadata: Dict) -> str:
    """
...
if __name__ == "__main__":
    ...
    update_model_armor_template_with_metadata("ma-crest-data-test", "us-central1", "test-template-update-metadata",data, {"name": "wrench", "count": "3"})
