# python-docs-samples/modelarmor/update_model_armor_template_with_mask_configuration.py
...
# [START update_model_armor_template_with_mask_configuration]
def update_model_armor_template_with_mask_configuration(project_id: str, location_id: str, template_id: str, updated_filter_config_data: Dict, mask_config: Dict) -> str:
    """
    ...
    # [END update_model_armor_template_with_mask_configuration]
...
if __name__ == "__main__":
    ...
    update_model_armor_template_with_mask_configuration("ma-crest-data-test", "us-central1", "temp-mihir",data, "filterConfig.raiSettings.raiFilters")
